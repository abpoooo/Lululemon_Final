...
export const OrderSuccess = () => {
    ...
    const transactionId =useSelector(state => state?.toBackendReducer?.transactionId)
    ...
    const afterTax = (sumTotal*1.13).toFixed(2)
    ...
    return (
        <>
            <div className='OrderSuccess'>
                ...
                <div className='OrderSuccess_info'>
                    <div className='OrderSuccess_info_Image'>
                        <CreditScoreOutlinedIcon style={{color: 'green', fontSize: '8rem'}}/>
                    </div>

                    <div className='OrderSuccess_info_Header'>
                        <h2>Thank You!</h2>
                        <span>Payment done Successfully</span>
                    </div>

                    <div className='OrderSuccess_info_Main'>
                        <div className='OrderSuccess_info_Main_Left'>
                            <span>Amount:</span>
                            <span>Payment Method:</span>
                            <span>Email:</span>
                            <span>Transaction Id:</span>
                        </div>
                        <div className='OrderSuccess_info_Main_Right'>
                            <span>${afterTax}</span>
                            <span>Credit Card</span>
                            <span>Mark2win@info.com</span>
                            <span>{transactionId}</span>
                        </div>

                    </div>

                    <div className='OrderSuccess_info_Button'>
                        <button
                            onClick={() => {navigate('/')
                                console.log('test')
                            }
            ...
            <div className='OrderSuccess_Media'>
